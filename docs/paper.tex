...
\author{\IEEEauthorblockN{Navadeep}
\IEEEauthorblockA{\textit{Department of AI} \\
\textit{Anurag University}\\
Hyderabad, India \\
navadeep@example.com}
\and
\IEEEauthorblockN{Inderneel}
\IEEEauthorblockA{\textit{Department of AI} \\
\textit{Anurag University}\\
Hyderabad, India \\
inderneel@example.com}
\and
\IEEEauthorblockN{Rithik Teja}
\IEEEauthorblockA{\textit{Department of AI} \\
\textit{Anurag University}\\
Hyderabad, India \\
rithik@example.com}
...
\textit{Anurag University}\\
Hyderabad, India \\
shanmukh@example.com}
\and
\IEEEauthorblockN{Dr./Mr. Ravi Krishna}
\IEEEauthorblockA{\textit{Guide, Department of AI} \\
\textit{Anurag University}\\
Hyderabad, India \\
